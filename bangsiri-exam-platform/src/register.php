	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-5">
		      	...
		      	<form action="api/signup.php" method="post" class="signin-form">
		      		<div class="form-group">
		      			<input type="text" name="num" class="form-control" placeholder="학번을 입력해주세요.(ex, 1234567)" required>
		      		</div>
		      		<div class="form-group">
		      			<input type="text" name="name" class="form-control" placeholder="이름을 입력해주세요.(ex, 박종상)" required>
		      		</div>
		      		<div class="form-group">
	            ...
	            <div class="form-group">
	              <input id="password-field" name="password2" type="password" class="form-control" placeholder="비밀번호를 다시 입력해주세요." required>
	              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
	            </div>
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-primary btn-outline-primary submit px-3">Sign Up</button>
	            </div>
	          </form>
