          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="/api/add_notice.php" method="post">
                <p> 아래 양식대로 등록할 공지사항을 입력해주세요. </p>
                <input type="text" name="title" class="form-control" placeholder="내용" required><br>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/api/del_notice.php" method="post">
                    <?php echo xss_secure($row['title']); ?><br>
